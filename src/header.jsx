        ...
        <>
                    ...
                    <div className="container-fluid d-lg-flex justify-content-between ">
                        ...
                        <div className="collapse navbar-collapse d-lg-flex " id="navbarNav">
                            <ul className="d-lg-flex t w-100 justify-content-end gap-4 fw-bold text-primary ">
                                <div>
                                    <Link className="nav-link" to="/"><div className="nav-item">Home</div></Link>
                                </div>
                                <div>
                                    <Link className="nav-link" to="/team.jsx"><div className="nav-item">Team</div></Link>
                                </div>
                                <div>
                                ...
                                <div>
                                    <Link className="nav-link" to="/blog.jsx"><div className="nav-item">Blog</div></Link>
                                </div>
                                <div>
                                    <a className="nav-link" href="#team"><div className="nav-item">Our team</div></a>
                                </div>
                                <div>
            ...
            <nav className="navbar navbar-light">
                <div className="navbar-nav flex-column">
                    <Link to="/" className="nav-item nav-link active"><span className="fas fa-home"></span> Home</Link>
                    <Link to="/team.jsx" className="nav-item nav-link"><span className="far fa-address-card"></span> Team</Link>
                    ...
                    <Link to="/blog.jsx" className="nav-item nav-link"><span className="fas fa-blog"></span> Blog</Link>
